...
//     // Replace text content with spans for split animation
...
//       {/* Track */}
//       <div ref={trackRef} className="relative w-full h-100 flex items-center justify-center">
//         {cardImages.map((img) => (
...
//         <h2 ref={titleRef} className="text-xl font-bold text-black" />
//         <p ref={locationRef} className="text-sm text-gray-500 mt-2" />
//       </div>
//     </div>
//   );
// };
